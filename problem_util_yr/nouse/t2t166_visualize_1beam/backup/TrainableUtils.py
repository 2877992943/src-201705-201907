...
if __name__ == '__main__':
  trainable = 'S临床表现 腹痛 S疼痛性质 隐痛 S方位 上方 E方位  E疼痛性质  E临床表现 S临床表现 乏力 E临床表现 S临床表现 体重下降 E临床表现 S临床表现 腹胀 E临床表现 S临床表现 纳差 E临床表现'
  revert = convertTrainable2Symptom(trainable)
