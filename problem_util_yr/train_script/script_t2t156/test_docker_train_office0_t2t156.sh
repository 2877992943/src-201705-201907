...
docker run --name chafang --runtime=nvidia -i -v $local_root_path:$virtual_root_path -v $local_root_path:$PYTHONPATH -e PYTHONPATH -w $virtual_root_path rxthinking:tensor2tensor_1.5.6 t2t-trainer \
