...
class ProblemDecoder_predict(object):
    ...
    def infer_singleSample(self, d, inputLengh_required_equalto_outputLength,
        ...
        inputs1 = inputs_vocab.encode(context)
        inputs2 = inputs_vocab.encode(question)
        question_sep_context=inputs2+[2]+inputs1
        inputs_id=copy.copy(question_sep_context)
        inputs=question_sep_context
        ####
