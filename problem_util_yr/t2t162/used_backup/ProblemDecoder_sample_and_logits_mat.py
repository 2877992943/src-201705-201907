...
class ProblemDecoder_predict(object):
    def __init__(self, problem, model_dir, model_name, hparams_set, usr_dir,
        ...
        #
        self._customer_problem_type=problem_type
        #选项 seq2seq,classification, languageModel_seq,languageModel_pp,seq2seq_logits
        if self._customer_problem_type=='seq2seq_logits':
            assert self._model_name == 'transformer_scorer_yr', u'如果需要logits 要用transformer_scorer_yr作为model_name'
