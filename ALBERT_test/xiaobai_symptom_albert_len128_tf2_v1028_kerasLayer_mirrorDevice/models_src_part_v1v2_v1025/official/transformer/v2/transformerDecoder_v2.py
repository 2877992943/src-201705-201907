...
#class TransformerDecoder(object):
  ...
  def __init__(self, params,train, name=None):
    ...
    """
    super(TransformerDecoder, self).__init__(name=name) ##yr
    self.params = params
    self.train = train
  ...
  #def call(self,input_ids,final_hidden,targets=None):
        ...
        "layer_0" : {
            "k":
                tf.zeros([
                    ...
                    dtype=self.params["dtype"],name='k0'),
            "v":
                tf.zeros([
                    batch_size, init_decode_length, num_heads, dim_per_head
                ],
                    dtype=self.params["dtype"],name='v0')
                    },
        "layer_1": {
            "k":
                tf.zeros([
                    ...
                    dtype=self.params["dtype"],name='k1'),
            "v":
                tf.zeros([
                    batch_size, init_decode_length, num_heads, dim_per_head
                ],
                    dtype=self.params["dtype"],name='v1')
                    }
            }
